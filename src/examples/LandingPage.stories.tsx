    ...
    <div style={{ minHeight: "100vh", backgroundColor: "var(--color-background-secondary)" }}>
      ...
      <div style={{ 
        ...
        <Stack direction="row" gap={4} justify="space-between" align="center">
          <Text size="xl" weight="bold">Design System</Text>
      ...
      <div style={{ 
        ...
        <Stack gap={6}>
          ...
          <Stack gap={4}>
            ...
            <Text size="xl" color="secondary" style={{ maxWidth: "600px", margin: "0 auto" }}>
              A modern, accessible design system built with React, TypeScript, and design tokens.
              Create consistent, beautiful user experiences.
            </Text>
          </Stack>
      ...
      {/* Features Section */}
      <div style={{ padding: "4rem 3rem", backgroundColor: "var(--color-background-primary)" }}>
        <Stack gap={8} style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <Text as="h2" size="4xl" weight="bold" style={{ textAlign: "center" }}>
            Key Features
          </Text>
            ...
            <Card padding={6} style={{ flex: "1 1 300px" }}>
              <Stack gap={4}>
                ...
                <Text color="secondary">
                  Framework-agnostic tokens using CSS custom properties and TypeScript constants.
                </Text>
              </Stack>
            </Card>
            <Card padding={6} style={{ flex: "1 1 300px" }}>
              <Stack gap={4}>
                ...
                <Text color="secondary">
                  Headless, accessible components that work with any styling approach.
                </Text>
              </Stack>
            </Card>
            <Card padding={6} style={{ flex: "1 1 300px" }}>
              <Stack gap={4}>
                ...
                <Text color="secondary">
                  Full type safety with strict mode for better developer experience.
                </Text>
              </Stack>
            </Card>
          </Stack>
      ...
      <div style={{ 
        ...
        <Stack gap={4} style={{ maxWidth: "1200px", margin: "0 auto", textAlign: "center" }}>
          <Text color="secondary">
            © 2024 @sergi-marquez/design-system. Built with React and TypeScript.
          </Text>
